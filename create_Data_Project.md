...
Open the Business Studio and select a workspace then# Build a data Project

For the Dispute BPM Project, We will start by creating a Business data project. Business Data projects are used to store business data models that will be referenced by process projects later in this workshop.

Open the Business Studio and select a workspace
...
Click and rename "Case1" to "Dispute"
...
## Let's start looking at building the form
## Next Step: [Building the project forms (_forms)](forms_project.md)


<!--//In the next section, we will create an Organisation project. Organization Projects defines the Models based upon which work assignment and allocation will work for your Automation process.
